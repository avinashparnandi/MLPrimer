...
for i=1:length(reachDataPareticAll)
    ...
    tempSize = size(reachDataPareticAll{i,1});
    for j=1: tempSize,
...
for i=1:length(retractDataPareticAll)
    ...
    tempSize = size(retractDataPareticAll{i,1});
...
for i=1:length(restDataPareticAll)
    ...
    tempSize = size(restDataPareticAll{i,1});
...
for i=1:length(stabilizeDataPareticAll)
    ...
    tempSize = size(stabilizeDataPareticAll{i,1});
...
for i=1:length(transportDataPareticAll)
    ...
    tempSize = size(transportDataPareticAll{i,1});
...
for i=1:length(reachDataNonPareticAll)
    ...
    tempSize = size(reachDataNonPareticAll{i,1});
    for j=1: tempSize,

        tempReachNonParetic = reachDataNonPareticAll{i,1}{j,1};
...
for i=1:length(retractDataNonPareticAll)
    ...
    tempSize = size(retractDataNonPareticAll{i,1});
...
for i=1:length(restDataNonPareticAll)
    ...
    tempSize = size(restDataNonPareticAll{i,1});
    for j=1: tempSize,
...
for i=1:length(stabilizeDataNonPareticAll)
    ...
    tempSize = size(stabilizeDataNonPareticAll{i,1});
...
for i=1:length(transportDataNonPareticAll)
    ...
    tempSize = size(transportDataNonPareticAll{i,1});
...
for i=1:length(reachDataPareticCanAll)
    ...
    tempSize = size(reachDataPareticCanAll{i,1});
    for j=1: tempSize,

        tempReachParetic = reachDataPareticCanAll{i,1}{j,1};
...
for i=1:length(retractDataPareticCanAll)
    ...
    tempSize = size(retractDataPareticCanAll{i,1});
...
for i=1:length(restDataPareticCanAll)
    ...
    tempSize = size(restDataPareticCanAll{i,1});
...
for i=1:length(stabilizeDataPareticCanAll)
    ...
    tempSize = size(stabilizeDataPareticCanAll{i,1});
...
for i=1:length(transportDataPareticCanAll)
    ...
    tempSize = size(transportDataPareticCanAll{i,1});
...
for i=1:length(reachDataNonPareticCanAll)
    ...
    tempSize = size(reachDataNonPareticCanAll{i,1});
    for j=1: tempSize,

        tempReachNonParetic = reachDataNonPareticCanAll{i,1}{j,1};
...
for i=1:length(retractDataNonPareticCanAll)
    ...
    tempSize = size(retractDataNonPareticCanAll{i,1});
...
for i=1:length(restDataNonPareticCanAll)
    ...
    tempSize = size(restDataNonPareticCanAll{i,1});
...
for i=1:length(stabilizeDataNonPareticCanAll)
    ...
    tempSize = size(stabilizeDataNonPareticCanAll{i,1});
...
for i=1:length(transportDataNonPareticCanAll)
    ...
    tempSize = size(transportDataNonPareticCanAll{i,1});
...
for i=1:length(reachDataPareticTpAll)
    ...
    tempSize = size(reachDataPareticTpAll{i,1});
    for j=1: tempSize,

        tempReachParetic = reachDataPareticTpAll{i,1}{j,1};
...
for i=1:length(retractDataPareticTpAll)
    ...
    tempSize = size(retractDataPareticTpAll{i,1});
...
for i=1:length(restDataPareticTpAll)
    ...
    tempSize = size(restDataPareticTpAll{i,1});
...
for i=1:length(stabilizeDataPareticTpAll)
    ...
    tempSize = size(stabilizeDataPareticTpAll{i,1});
...
for i=1:length(transportDataPareticTpAll)
    ...
    tempSize = size(transportDataPareticTpAll{i,1});
...
for i=1:length(reachDataNonPareticTpAll)
    ...
    tempSize = size(reachDataNonPareticTpAll{i,1});
    for j=1: tempSize,

        tempReachNonParetic = reachDataNonPareticTpAll{i,1}{j,1};
...
for i=1:length(retractDataNonPareticTpAll)
    ...
    tempSize = size(retractDataNonPareticTpAll{i,1});
...
for i=1:length(restDataNonPareticTpAll)
    ...
    tempSize = size(restDataNonPareticTpAll{i,1});
...
for i=1:length(stabilizeDataNonPareticTpAll)
    ...
    tempSize = size(stabilizeDataNonPareticTpAll{i,1});
...
for i=1:length(transportDataNonPareticTpAll)
    ...
    tempSize = size(transportDataNonPareticTpAll{i,1});
